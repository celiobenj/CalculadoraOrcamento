...
public class ItemOrcamentado {
    ...
    // Getters e Setters
    public int getCodItemOrcamentado() { return codItemOrcamentado; }
    public void setCodItemOrcamentado(int codItemOrcamentado) { this.codItemOrcamentado = codItemOrcamentado; }
    ...
    public void setValorItemTotal() { this.valorItemTotal = this.item.getValor() * quantidadeUtilizada;}
